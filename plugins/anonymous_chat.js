async function handler(m, {usedPrefix, command}) {
  ...
  switch (command) {
    ...
    case 'leave': {
      ...
      if (!room) return this.sendMessage(other, {text: `*[❗تنبيه❗] انت لست في دردشة مجهولة*\n\n*هل تريد ان تبدا واحدة?*\nوصف ${usedPrefix}start`}, {quoted: m});
      ...
      m.reply('*[ ✔ ] تم الخروج من الدردشة المجهولة بنجاح *');
