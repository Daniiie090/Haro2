...
const handler = async (m, {conn, command, args, text, usedPrefix}) => {
  if (!text) throw `*[❗𝐈𝐍𝐅𝐎❗] هذا الامر خاص بتحميل المقاطع الصوتية على شكل مستند لكي يتم حفظها فل هاتف بسهولة*\n\n*—◉ مثال:*\n*${usedPrefix + command} Good gods - Tatto* `;
  try {
