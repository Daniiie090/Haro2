...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*[❗] أدخل نصًا للبحث، مثال:${usedPrefix + command} TheMystic-Bot-MD*`;
...
📅 *صنع في تاريخ:* ${formatDate(repo.created_at)}
🔄 *تم تحديثه في:* ${formatDate(repo.updated_at)}
📥 *استنسخ:* $ احصل على نسخة ${repo.clone_url}
